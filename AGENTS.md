...
npm test          # node --test (currently 62 tests) — MUST stay green
...
3. **Member portal + site CMS (Plan C / Phase 2):** decisions locked — portal via **GHL native** (memberships/community), content editing via a **git-based CMS (Sveltia recommended)**, Supabase stays the fact-store. Not started. Doc: `docs/superpowers/specs/2026-08-14-member-portal-and-cms-architecture.md`.
